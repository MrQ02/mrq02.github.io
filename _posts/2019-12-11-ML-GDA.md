...
## <a name="gda"></a>Gaussian Discriminant Analysis (GDA)
...
## <a name="nb"></a>Naive Bayes Classifier
...
- **Laplace Smoothing**
    ...
    1. Problem with NB
        ...
        What if there is a new word "mrbeast" in the email for prediction that our NB classifier has never learnt ever since it was born?
